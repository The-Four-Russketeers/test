"""
Django settings for SchedulingBackend project.
...
SECRET_KEY = 'django-insecure-_se5voq(dgg=5kcu=6-keii)s*xw^+f3azd_owukihph4br&5p'
...
ROOT_URLCONF = 'SchedulingBackend.urls'
...
WSGI_APPLICATION = 'SchedulingBackend.wsgi.application'
